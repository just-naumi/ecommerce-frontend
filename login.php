...
<div class="login-page">
  ...
  <div class="login-right fade-up">
    ...
    <div class="alert-success" style="background:#e6f4ea;color:#1e8e3e;padding:12px;border-radius:6px;margin-bottom:20px;font-size:14px;border:1px solid #ceead6;"><i class="fas fa-check-circle"></i> Pendaftaran berhasil! Silakan masuk dengan akun baru Anda.</div>
    <?php endif;?>
